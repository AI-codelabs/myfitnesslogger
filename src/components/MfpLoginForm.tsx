    ...
    <div className="max-w-lg mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Enter your MyFitnessPal credentials to pull in your food diary.
          Your credentials are used to create a session and are never stored.
        </p>
      </div>
