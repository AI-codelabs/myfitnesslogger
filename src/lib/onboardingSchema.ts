...
export const onboardingSections: Section[] = [
  {
    ...
    fields: [
      { name: "first_name", label: { nl: "Voornaam", en: "First name" }, type: "text", storeIn: "details" },
      { name: "last_name", label: { nl: "Achternaam", en: "Last name" }, type: "text", storeIn: "details" },
    ...
    fields: [
      {
        ...
        storeIn: "details",
        options: [
          { value: "cut", label: { nl: "Vet verliezen / Cutten", en: "Fat loss / Cutting" } },
          { value: "bulk", label: { nl: "Spiermassa opbouwen / Bulken", en: "Muscle gain / Bulking" } },
          { value: "maintain", label: { nl: "Onderhoud", en: "Maintenance" } },
          { value: "custom", label: { nl: "Aangepast doel", en: "Custom goal" } },
        ],
      },
      { name: "goal_weight_kg", label: { nl: "Streefgewicht (kg)", en: "Target weight (kg)" }, type: "number", optional: true, storeIn: "details" },
      { name: "goal_reason", label: { nl: "Waarom is dit doel belangrijk voor je?", en: "Why is this goal important to you?" }, type: "textarea" },
      { name: "target_outcome", label: { nl: "Concreet streefresultaat (zoals uiterlijk)?", en: "Concrete target outcome (e.g. look)?" }, type: "textarea", optional: true },
